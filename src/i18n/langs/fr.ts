export default {
	...
	ABONNE: 'Abonné',
	ACCES: 'Accès',
	ACCES_TRANSPORT_PUBLIC: 'Accès et transport public',
	...
	CINEMA: 'Cinéma',
	CINEMA_DESC_PART1:
		"Notre charmant cinéma, classé Art & Essai, est une véritable salle de proximité, pensée pour ouvrir les horizons et éveiller la curiosité à travers le 7ᵉ art. Sous sa belle charpente atypique, nous proposons tout au long de l'année une programmation diversifiée, mêlant découvertes, émotions et rendez-vous cinéma.",
	CINEMA_DESC_PART2:
	...
	ESPACE_CULTURE_DESC_PART2:
		"C'est un centre culturel, un lieu unique qui propose des spectacles, des films, des expositions, des conférences, des ateliers, une médiathèque, une ludothèque, et qui héberge aussi des associations socio-culturelles à destination de la population locale ou de passage.",
	ESPACE_CULTURE_DESC_PART3:
		"Le lieu, ouvert à l'année, est porté par la commune de Luz Saint Sauveur et le Parc national des Pyrénées. Il propose une saison culturelle avec une trentaine de spectacles par an, une programmation cinéma art et essai de huit séances par semaine en moyenne, un espace médiathèque, une salle d'exposition et un accueil nature  en lien avec le Parc national.",
	ESPACE_CULTURE_DESC_PART4:
	...
	RESIDENCE_DESC_PART1:
		"La résidence artistique est un temps privilégié dédié à la création, à la recherche et à l'expérimentation. Elle offre aux artistes et aux compagnies un espace, des moyens et un cadre propice pour développer un projet artistique, affiner une écriture ou finaliser une œuvre.",
	...
	SPECTACLES_DESC_PART1:
		"Tout au long de l'année, nous vous invitons à vivre des moments fabuleux grâce à une programmation d'art vivant riche et vibrante.",
	SPECTACLES_DESC_PART2:
		"Spectacles, marionnettes, cirque, concerts, danse… Nous avons à cœur de mettre en lumière les compagnies locales qui s'emparent de la création artistique pour vous transporter dans leurs univers.",
	...
	SPECTACLES_JEUNE_PUBLIC_DESC:
		"Tout au long de l'année, La Maison invite les enfants et leurs familles à découvrir des spectacles pensés pour le jeune public, afin d'éveiller la curiosité et le goût de l'art vivant dès le plus jeune âge.",
	...
	VALEURS_DESC:
		'Dans le cadre de ses actions et de sa programmation, la Maison du Parc national et de la vallée affirme des engagements forts, guidés par des valeurs humaines et responsables.',

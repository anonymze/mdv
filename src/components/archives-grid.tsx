...
const fetchData = async () => {
	...
	return (
		<>
			...
			<div id="archives-grid" className={`scroll-m-20 py-8 lg:py-16 grid grid-cols-[repeat(auto-fit,320px)] justify-center ${data.docs.length === 2 ? 'lg:justify-start' : 'lg:justify-between'} content-start gap-x-4 gap-y-8 *:only:col-span-full min-h-104`}>
				{loading ? (
